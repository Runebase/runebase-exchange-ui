...
// Material Theme for RunebaseExchange
...
export const theme = {
  ...
  typography: {
    ...
    // large headline (i.e. title on exchange title)
    display1: {
    ...
    // large text (i.e. title on exchange title)
    title: {
...
const runebaseexchangeTheme = createMuiTheme(theme);

export default runebaseexchangeTheme;

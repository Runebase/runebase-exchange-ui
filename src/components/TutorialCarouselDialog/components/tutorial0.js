...
const messages = defineMessages({
  tutorial0Content0Msg: {
    ...
    defaultMessage: 'RunebaseExchange Dapp is a free, open-source, client-side interface.',
  },
  ...
  tutorial0Content2Msg: {
    ...
    defaultMessage: 'RunebaseExchange Dapp is NOT a standalone wallet. We use the Runebase Core Wallet to handle all transactions and interactions with the Runebase blockchain.',
  },

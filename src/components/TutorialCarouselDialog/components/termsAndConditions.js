    ...
    <Paper className={classes.tncWrapper}>
      ...
      <div>
        ...
        <ul>
          ...
          <li><FormattedMessage id="tnc.definitions6" defaultMessage="“PRED” shall mean the utility token which is the RunebaseExchange Token (PRED) cryptocurrency." /></li>

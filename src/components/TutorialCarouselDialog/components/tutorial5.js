...
const messages = defineMessages({
  ...
  tutorial5Content4Msg: {
    ...
    defaultMessage: 'When you see your balance on RunebaseExchange Dapp, the Runebase Wallet, or view your transactions on the Runebase Explorer, you are seeing data on the blockchain, not in our personal systems.',
  },
});

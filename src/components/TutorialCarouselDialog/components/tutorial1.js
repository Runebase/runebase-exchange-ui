...
const messages = defineMessages({
  tutorial1Content0Msg: {
    ...
    defaultMessage: 'Assuming you have not used the Runebase Wallet client before, when you first open the RunebaseExchange Dapp, you are generating a brand new Runebase wallet. ',
  },
